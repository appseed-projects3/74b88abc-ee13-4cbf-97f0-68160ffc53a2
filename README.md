...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-28 01:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/74b88abc-ee13-4cbf-97f0-68160ffc53a2.git
$ cd 74b88abc-ee13-4cbf-97f0-68160ffc53a2
```
